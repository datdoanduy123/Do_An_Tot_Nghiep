...
namespace DocTask.Data.Migrations
{
    ...
    [Migration("20260214143734_AddSmartAssignmentFields")]
    partial class AddSmartAssignmentFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DocTask.Core.Models.TaskDraft", b =>
                {
                    ...
                    b.ToTable("task_draft", (string)null);
                });

            modelBuilder.Entity("DocTask.Core.Models.TaskDraftSkill", b =>
                {
                    b.Property<int>("DraftSkillId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("draftSkillId");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("DraftSkillId"));
                    ...
                    b.HasKey("DraftSkillId");

                    b.HasIndex("SkillId");

                    b.HasIndex("DraftId", "SkillId")
                        .IsUnique()
                        .HasDatabaseName("UQ_TaskDraftSkill_Draft_Skill");

                    b.ToTable("task_draft_skill", (string)null);
                });
            ...
            modelBuilder.Entity("DocTask.Core.Models.Task", b =>
                {
                    ...
                    b.HasOne("DocTask.Core.Models.Task", "ParentTask")
                        .WithMany()
            ...
            modelBuilder.Entity("DocTask.Core.Models.TaskDraft", b =>
                {
                    b.HasOne("DocTask.Core.Models.User", "Creator")
                        .WithMany()
                        .HasForeignKey("CreatedBy")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                    ...
                    b.HasOne("DocTask.Core.Models.Task", "CreatedTask")
                        .WithMany()
                    ...
                    b.HasOne("DocTask.Core.Models.TaskDraft", "ParentDraft")
                        .WithMany("InverseParentDraft")
            ...
            modelBuilder.Entity("DocTask.Core.Models.TaskDraftSkill", b =>
                {
                    b.HasOne("DocTask.Core.Models.TaskDraft", "Draft")
                        .WithMany("DraftSkills")
            ...
            modelBuilder.Entity("DocTask.Core.Models.TaskDraft", b =>
                {
                    b.Navigation("DraftSkills");

                    b.Navigation("InverseParentDraft");
                });
